...
let company = [];
runners.forEach(function(firstLast) {
  company.push(firstLast.company_name);
});
...
runners.forEach(function(items)
  ...
  {
  lastEmail.push(items.last_name + " " + items.email)
